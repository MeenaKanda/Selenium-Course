...
/*		boolean flagImg = driver.findElement(By.className("img-responsive")).isDisplayed();
		...
		boolean flagSearch = driver.findElement(By.name("search")).isDisplayed();   //verify search displaying or not
		if(flagSearch) {
			System.out.println("PASS");
			driver.findElement(By.name("search")).sendKeys("macbook"); // if yes then apply value
		}*/
